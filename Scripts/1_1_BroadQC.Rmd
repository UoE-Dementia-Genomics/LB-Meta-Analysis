...
# Remove cross hybridising and SNP containing probes 
...
# 
betas.pfc<-betas.pfc[!(rownames(betas.pfc) %in% crosshyb[,1]), ]
betas.pfc<-betas.pfc[!(rownames(betas.pfc) %in% unique(snpProbes$IlmnID)), ]
betas.pfc<-betas.pfc[-grep("rs", rownames(betas.pfc)),]

betas.cng<-betas.cng[!(rownames(betas.cng) %in% crosshyb[,1]), ]
betas.cng<-betas.cng[!(rownames(betas.cng) %in% unique(snpProbes$IlmnID)), ]
betas.cng<-betas.cng[-grep("rs", rownames(betas.cng)),]

save(betas.pfc, file =  "/mnt/data1/LewyBodyMRC/Methylation/QC/FinalData/betasPFC")
save(betas.cng, file = "/mnt/data1/LewyBodyMRC/Methylation/QC/FinalData/betasCNG.Rdata")
