...
Rscript /lustre/projects/Research_Project-T112069/Meth/QTL/Scripts/QTL-Analysis/SNCA/PrepareData.R ${GenotypeBinaryPrefix}.fam ${OutPrefix}.eigenvec $ExpressionFile $PhenotypeFile $GeneLocationFile "$FactCovar" "$NumCovar" "$OutPrefix" $chr
