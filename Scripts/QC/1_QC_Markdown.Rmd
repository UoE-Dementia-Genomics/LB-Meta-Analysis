...
SummaryDF
pheno <- pheno[-which(pheno$M.median < 1500 | pheno$U.median < 1000 | 
                         pheno$bs < 80 | pheno$outliers == TRUE | pheno$crypticQC == TRUE | pheno$P.filter == TRUE),]
```
...
#save(pheno, betas, wlmn_est, file = "/mnt/data1/LewyBodyMRC/Methylation/QC/FinalData/Final_Filtered/LB_MRC_Norm_Filtered.rdat")
```
